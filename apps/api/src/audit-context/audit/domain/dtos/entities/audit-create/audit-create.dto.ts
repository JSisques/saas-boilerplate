import { AuditAggregateIdValueObject } from '@/audit-context/audit/domain/value-objects/audit-aggregate-id/audit-aggregate-id.vo';
import { AuditAggregateTypeValueObject } from '@/audit-context/audit/domain/value-objects/audit-aggregate-type/audit-aggregate-type.vo';
import { AuditEventTypeValueObject } from '@/audit-context/audit/domain/value-objects/audit-event-type/audit-event-type.vo';
import { AuditPayloadValueObject } from '@/audit-context/audit/domain/value-objects/audit-payload/audit-payload.vo';
import { AuditTimestampValueObject } from '@/audit-context/audit/domain/value-objects/audit-timestamp/audit-timestamp.vo';
