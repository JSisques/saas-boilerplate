...
import {
  AUDIT_FACTORY_TOKEN,
  AuditFactory,
} from '@/audit-context/audit/domain/factories/audit.factory';
import {
...
```typescript
import { YourEventEventHandler } from '@/audit-context/audit/application/event-handlers/your-domain/your-event/your-event.event-handler';
```
