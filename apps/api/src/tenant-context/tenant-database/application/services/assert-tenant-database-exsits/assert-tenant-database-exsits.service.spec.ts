...
describe('AssertTenantDatabaseExsistsService', () => {
  let service: AssertTenantDatabaseExsistsService;
  ...
  beforeEach(() => {
    ...
    service = new AssertTenantDatabaseExsistsService(
      mockTenantDatabaseWriteRepository,
    );
  });
  ...
  describe('execute', () => {
    ...
    it('should throw TenantDatabaseNotFoundException when tenant database does not exist', async () => {
      const tenantDatabaseId = '123e4567-e89b-12d3-a456-426614174000';
