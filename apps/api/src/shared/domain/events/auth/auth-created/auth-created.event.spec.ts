...
describe('AuthCreatedEvent', () => {
  ...
  it('should be an instance of BaseEvent', () => {
    ...
    const event = new AuthCreatedEvent(metadata, data);
  ...
  it('should generate a unique eventId', () => {
    ...
    const event1 = new AuthCreatedEvent(metadata, data);
    const event2 = new AuthCreatedEvent(metadata, data);
  ...
  it('should handle isReplay flag correctly', () => {
    const metadata = createMetadata();
