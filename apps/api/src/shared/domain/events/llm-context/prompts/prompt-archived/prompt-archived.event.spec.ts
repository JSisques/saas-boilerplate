...
describe('PromptArchivedEvent', () => {
  ...
  it('should be an instance of BaseEvent', () => {
    ...
    const event = new PromptArchivedEvent(metadata, data);
  ...
  it('should generate a unique eventId', () => {
    ...
    const event1 = new PromptArchivedEvent(metadata, data);
    const event2 = new PromptArchivedEvent(metadata, data);
