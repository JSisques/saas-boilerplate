...
describe('SubscriptionActivatedEvent', () => {
  ...
  it('should be an instance of BaseEvent', () => {
    ...
    const event = new SubscriptionActivatedEvent(metadata, data);
  ...
  it('should generate a unique eventId', () => {
    ...
    const event1 = new SubscriptionActivatedEvent(metadata, data);
    const event2 = new SubscriptionActivatedEvent(metadata, data);
