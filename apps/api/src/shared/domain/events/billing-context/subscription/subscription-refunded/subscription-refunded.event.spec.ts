...
describe('SubscriptionRefundedEvent', () => {
  ...
  it('should be an instance of BaseEvent', () => {
    ...
    const event = new SubscriptionRefundedEvent(metadata, data);
  ...
  it('should generate a unique eventId', () => {
    ...
    const event1 = new SubscriptionRefundedEvent(metadata, data);
    const event2 = new SubscriptionRefundedEvent(metadata, data);
