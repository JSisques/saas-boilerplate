/**
 * Script to run migrations for tenant databases
 *
 * Usage:
 * - Migrate specific tenant: npm run migrate:tenant <tenantId>
 * - Migrate all tenants: npm run migrate:tenant:all
 */
...
async function migrateTenant() {
  ...
  const migrationService = app.get(TenantDatabaseMigrationService);
